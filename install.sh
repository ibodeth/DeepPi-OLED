...
sudo apt install -y python3-venv python3-pip git portaudio19-dev libasound2-dev i2c-tools libopenjp2-7 libtiff5 libjpeg-dev
...
# 5. MODEL (DÜZELTİLDİ: 7B Versiyonu)
echo -e "${YELLOW}[5/8] Pulling DeepSeek R1 (7B) model...${NC}"
# BURASI KRİTİK: Düz 'deepseek-r1' değil, ':7b' etiketiyle çekiyoruz.
...
pip install RPi.GPIO ollama luma.oled SpeechRecognition pyaudio requests
...
# --- CONFIG ---
BUTTON_PIN = 17
# DÜZELTİLDİ: Model ismi 7b olarak ayarlandı
